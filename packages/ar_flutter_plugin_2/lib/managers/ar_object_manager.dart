...
class ARObjectManager {
  ...
  /// Plays a specific animation on a given node
  Future<void> playAnimation({required String nodeName, required String animationName, bool loop = true}) async {
    try {
      await _channel.invokeMethod<void>('playAnimation', {
        'name': nodeName,
        'animation': animationName,
        'loop': loop,
      });
    } catch (e) {
      print("playAnimation failed (may be unsupported on this platform): $e");
    }
  }

  /// Sets the metallic factor on a given node
  Future<void> setMetallic({required String nodeName, required double metallicFactor}) async {
    try {
      await _channel.invokeMethod<void>('setMetallic', {
        'name': nodeName,
        'metallic': metallicFactor,
      });
    } catch (e) {
      print("setMetallic failed (may be unsupported on this platform): $e");
    }
  }
}
