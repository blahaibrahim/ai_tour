...
/**
 * Where a signed-in traveller lands, and where they return between trips.
 *
 * It sits at `/home` rather than at `/`, because `/` is the public landing page
 * — the one surface a visitor with no account is allowed to see. Everything
 * below this line assumes a session, which is what `requireSession` guarantees.
 *
